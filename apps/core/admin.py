...
class NewsAdmin(admin.ModelAdmin):
    ...
    ordering = ('-updated_at', 'news_title', 'author__email')
    search_fields = ('news_title', 'author__email')
...
class NewsCommentAdmin(admin.ModelAdmin):
    ...
    ordering = ('-published_at', 'comment_author__email', 'news__news_title')
    search_fields = ('comment_text', 'comment_author__email', 'news__news_title')
...
class EventAdmin(admin.ModelAdmin):
    ...
    ordering = ('-updated_at', 'event_title', 'event_author__email')
...
class EventCommentAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['comment_slug', 'liked', 'disliked', 'liked_count', 'disliked_count']
    ordering = ('-published_at', 'comment_author__email', 'event__event_title')
    search_fields = ('comment_text', 'comment_author__email', 'event__event_title')
    list_filter = ('active', 'published_at', LikedCountListFiilter, DislikedCountListFilter)
    date_hierarchy = 'published_at'
    list_per_page = 20
