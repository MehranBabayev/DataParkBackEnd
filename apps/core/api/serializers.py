...
class NewsCommentPostSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        attrs['comment_author'] = User.objects.first()
        return attrs
...
class NewsDetailSerializer(serializers.ModelSerializer):
    ...
    def get_news_image(self, obj):
        request = self.context.get('request')
        if request and obj.news_image:
            return request.build_absolute_uri(obj.news_image.url)
        return None
...
class NewsPostSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
            ...
            attrs['author'] = User.objects.first()
            return attrs
