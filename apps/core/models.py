...
from apps.core.utils.manager import (
...
class News(Base):
    ...
    author = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='news', null=True, blank=True)
...
class News_comment(Base):
    ...
    comment_author = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='news_comments', null=True, blank=True)
    liked = models.ManyToManyField(CustomUser, related_name='news_liked_comments', verbose_name='Bəyənənlər', editable=False)
    disliked = models.ManyToManyField(CustomUser, related_name='news_disliked_comments', verbose_name='Bəyənməyənlər', editable=False)
    objects = models.Manager()
...
class Event(Base):
    ...
    event_author = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='events', null=True, blank=True)
...
class Event_comment(Base):
    ...
    active = models.BooleanField(default=True)
    comment_author = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='event_comments', null=True, blank=True)
    liked = models.ManyToManyField(CustomUser, related_name='event_liked_comments', verbose_name='Bəyənənlər', editable=False)
    disliked = models.ManyToManyField(CustomUser, related_name='event_disliked_comments', verbose_name='Bəyənməyənlər', editable=False)
    objects = models.Manager()
